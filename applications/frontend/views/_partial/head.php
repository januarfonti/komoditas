...
<html lang="en">
  ...
  <body class="preload tile-1-bg">
    ...
    <div class="page-preloader">
      <div class="vcenter"> <div class="vcenter-this"><img class="anim" src="<?php echo base_url(); ?>assets/dist/images/loader.gif" alt="loading..." /></div></div>
    </div>
    <!-- /Preloader 
    ============================================ --> 
            ...
            <div class="brand-col hidden-xs">
              ...
              <div class="vcenter">
                ...
                <div class="vcenter-this">
                  <a href="index.html">
                    <img src="<?php echo base_url('assets/dist/images/logo.png'); ?>" alt="Komoditas">
                  </a>
                </div>
                <!-- v-centered -->
              </div>
